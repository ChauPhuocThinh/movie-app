...
export default function SeriesDetail(props) {
  ...
  const id = window.location.href.replace(`${process.env.REACT_APP_CLIENT_URL}/series/`,'')
  useEffect(()=>{
    axios.get(`${process.env.REACT_APP_API_URL}/series/${id}`)
      .then(res=>{
                ...
                <div className="dropdown is-hoverable">
                  ...
                  {favoriteAdded === false ?
                      ...
                      <button className="remove-favorite button is-info is-outlined unadded" onClick={removeFavorite}>
                        ...
                        <Box sx={{ display: loading }}>
                          <CircularProgress Muốn Xem size={20}/>
                        </Box>
                      </button>
                    }
                  </div>
