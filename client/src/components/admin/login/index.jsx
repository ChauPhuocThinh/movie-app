...
export default function Login(props) {
  ...
  const handleSubmit=(e)=>{
    ...
    axios.post(`${process.env.REACT_APP_API_URL}/admin/login`,data)
      .then((res)=>{
        if(res.data.message === 'successfully'){
          setCookie('token_admin', res.data.token, 90)
          window.location.href = `${process.env.REACT_APP_CLIENT_URL}/admin`
  ...
  }else {window.location.href = `${process.env.REACT_APP_CLIENT_URL}/admin`}
